...
class NewCube():
    ...
    def make_RHT_XYT_cube(self, rht_velstart="0974", rht_velstop="0978"):
        ...
        for ra, dec in self.all_RADEC_str_pairs:
            ...
            print("In integers, x goes from {} to {}, y from {} to {}".format(new_xmin, new_xmax, new_ymin, new_ymax))
...
gg2=galfa_cuber.Cube(RA="012.00", DEC="10.35")
gg2_cube_wcs = cutouts.make_wcs(gg2.ppv_cube_fn)
ra0, dec0 = cutouts.xy_to_radec(0, 0, gg2_cube_wcs, origincoord=0)
print(ra0, dec0)
ramid, decmid = cutouts.xy_to_radec(256.5, 0, gg2_cube_wcs, origincoord=0)
print(ramid, decmid)
